import os
result_list = []
dir_list = ["_DRRIP", "_SRRIP", "_RANDOM", "_LRU"]
file_list = os.listdir("CRC/_DRRIP")
for filename in file_list:
    single_list = []
    for dirname in dir_list:
        one_dict = {"Policy": dirname + '/' + filename}
        f = open("CRC/" + dirname + "/" + filename, 'r')
        lines = f.readlines()
        for line in lines:
